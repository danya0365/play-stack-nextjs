    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 relative">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              เรียนรู้ <span className="text-yellow-400">JavaScript</span> & <span className="text-blue-400">TypeScript</span>
            </h1>
          ...
          <div className="grid grid-cols-3 gap-4 max-w-xl mx-auto mb-12">
            <div className="bg-white/5 backdrop-blur rounded-xl p-4 text-center border border-white/10">
              <div className="text-3xl font-bold text-white">{learnLessons.length}</div>
              <div className="text-sm text-gray-400">บทเรียน</div>
            </div>
            <div className="bg-white/5 backdrop-blur rounded-xl p-4 text-center border border-white/10">
              <div className="text-3xl font-bold text-white">{learnTopics.length}</div>
              <div className="text-sm text-gray-400">หัวข้อ</div>
            </div>
            <div className="bg-white/5 backdrop-blur rounded-xl p-4 text-center border border-white/10">
              <div className="text-3xl font-bold text-indigo-400">{totalProgress.percent}%</div>
              <div className="text-sm text-gray-400">เรียนแล้ว</div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 -mt-8">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Link href="/learn/javascript" className="group">
            <div className="relative bg-gradient-to-br from-yellow-500/10 to-orange-500/10 rounded-3xl p-8 border border-yellow-500/20 hover:border-yellow-500/40 transition-all hover:scale-[1.02] overflow-hidden">
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-yellow-400">{jsProgress.percent}%</div>
                  <div className="text-sm text-gray-400">{jsProgress.completed}/{jsProgress.total}</div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {jsTopics.slice(0, 4).map(topic => (
                  <span key={topic.id} className="px-3 py-1 bg-yellow-500/10 text-yellow-300 rounded-full text-sm">
              ...
              <div className="mt-6 flex items-center text-yellow-400 font-medium">
          ...
          <Link href="/learn/typescript" className="group">
            <div className="relative bg-gradient-to-br from-blue-500/10 to-indigo-500/10 rounded-3xl p-8 border border-blue-500/20 hover:border-blue-500/40 transition-all hover:scale-[1.02] overflow-hidden">
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-blue-400">{tsProgress.percent}%</div>
                  <div className="text-sm text-gray-400">{tsProgress.completed}/{tsProgress.total}</div>
                </div>
              </div>
      ...
      <div className="bg-slate-800/30 border-y border-slate-700/50">
        <div className="max-w-6xl mx-auto px-4 py-12">
          <h3 className="text-xl font-bold text-white text-center mb-8">ทำไมต้องเรียนที่นี่?</h3>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 text-center">
        <h3 className="text-2xl font-bold text-white mb-4">พร้อมเริ่มเรียนแล้วหรือยัง?</h3>
        <div className="flex justify-center gap-4">
          <Link href="/learn/javascript" className="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold rounded-xl transition-colors">
            เริ่มจาก JavaScript
          </Link>
          <Link href="/playground" className="px-6 py-3 bg-slate-700 hover:bg-slate-600 text-white font-semibold rounded-xl transition-colors">
            🎮 ลองใน Playground
          </Link>
        </div>
      </div>
